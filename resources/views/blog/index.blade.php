...
@foreach ($posts as $post )
                ...
                <div>
                    ...
                    <div class="ml-2">
                        <img  src="{{ asset('images/' . $post->image_path) }}" width="700px" alt="" srcset="">
                    </div>
                ...
                <div>
                    ...
                    <a href="/blog/{{ $post->slug }}" class="uppercase bg-blue-500 text-gray-100 text-lg font-extrabold py-4 px-8 rounded-3xl" href=""> keep readding </a>
                        ...
                        @if (isset(Auth::user()->id) && Auth::user()->id == $post->user_id)
                            ...
                            <span class="float-right">
                                <form action="/blog/{{ $post->slug }}" method="POST"
                                 class="text-red-700 italic hover:text-red-900 pb-1 border-b-2">
                                    @csrf 
                                    @method('delete')
